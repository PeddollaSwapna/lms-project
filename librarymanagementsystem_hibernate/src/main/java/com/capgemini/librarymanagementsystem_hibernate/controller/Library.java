									...
									do {
										try {
											...
											case 13:
												...
												try {
													boolean updated = service3.updatePassword(id, old_Password, new_Password, user_Role);
													if (updated) {
														System.out.println("-----------------------------------------------");
									...
									do {
										try {
											...
											case 8:
												...
												String user_Role = loginInfo.getRole();
												try {
													boolean updated = service3.updatePassword(id1, old_Password, new_Password, user_Role);
													if (updated) {
														System.out.println("-----------------------------------------------");
														System.out.println("Password is updated");
													} else {
