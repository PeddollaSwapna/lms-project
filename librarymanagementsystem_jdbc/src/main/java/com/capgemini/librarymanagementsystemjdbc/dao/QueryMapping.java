...
public interface QueryMapping {
	...
	String issueBookQuery="select * from bookbean where bid=?";
	...
	String requestQuery3= "insert into request_details values(?,(select concat(firstname,'_',lastname) from users where uid=?),?,(select bookname from bookbean where bid=?),(select email from users where uid=?))";
	...
	String returnBookQuery="select * from bookBean where bid=?";
