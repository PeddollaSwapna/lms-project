											...
											case 1:
												...
												do {
													try {
														...
														bookPulisherName = scanner.next();
														validation.validatedName(bookPulisherName);
														flag = true;
													} catch (InputMismatchException e) {
														flag = false;
												...
												/*
												 * System.out.println("enter id"); int addId=scanner.nextInt();
												 * System.out.println("enter bookname"); String addName=scanner.next();
												 * System.out.println("enter authorname"); String
												 * addAuth=scanner.next(); System.out.println("enter category"); String
												 * addCategory=scanner.next(); System.out.println("enter publisher");
												...
												bi.setPublisher(bookPulisherName);
												try {
													...
													if(check2) {
														...
														System.out.println("-----------------------------------------------");
														System.out.println("Book not added of id ="+bookId);
													}
												}catch (LMSException e) {
													System.err.println(e.getMessage());
												}
